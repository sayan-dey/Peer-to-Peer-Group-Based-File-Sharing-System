...
void upload_file(string group_id,string FileId)
{
   ...
   cout<<"no_of_chunks="<<no_of_chunnk<<endl;
...
{
   cout<<"You have to join group: "<<group_id<<"  to download this file"<<endl;
  goto l2; 
          ...
          if(requestParse.size()!=3)
            {
               ...
               string FileId=requestParse[1];
               string group_id=requestParse[2];
